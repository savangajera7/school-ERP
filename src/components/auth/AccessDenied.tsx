...
export function AccessDenied({
  ...
  return (
    <View className="flex-1 items-center justify-center p-8 bg-[#F4F6FA]">
      ...
      <Text className="text-lg font-black text-gray-900 dark:text-slate-100 mt-4 text-center">Access restricted</Text>
      <Text className="text-sm text-gray-500 dark:text-slate-400 text-center mt-2 leading-5">{message}</Text>
      <TouchableOpacity
        onPress={() => router.back()}
